...
bool esOca(int casilla) {
	bool oca = false;
	while (!(casilla != CASILLA_OCA_1 && casilla != CASILLA_OCA_2 && casilla != CASILLA_OCA_3 && casilla != CASILLA_OCA_4 && casilla != CASILLA_OCA_5 && casilla != CASILLA_OCA_6 && casilla != CASILLA_OCA_7 && casilla != CASILLA_OCA_8 && casilla != CASILLA_OCA_9 && casilla != CASILLA_OCA_10 && casilla != CASILLA_OCA_11 && casilla != CASILLA_OCA_12 && casilla != CASILLA_OCA_13 && casilla != CASILLA_OCA_14)) {
		oca = true;
		casilla++;
	}
	return oca;
...
int siguienteOca(int casilla) {
	int x = casilla + 1;
	while ((x != CASILLA_OCA_1 && x != CASILLA_OCA_2 && x != CASILLA_OCA_3 && x != CASILLA_OCA_4 && x != CASILLA_OCA_5 && x != CASILLA_OCA_6 && x != CASILLA_OCA_7 && x != CASILLA_OCA_8 && x != CASILLA_OCA_9 && x != CASILLA_OCA_10 && x != CASILLA_OCA_11 && x != CASILLA_OCA_12 && x != CASILLA_OCA_13 && x != CASILLA_OCA_14)){
		x++;
	}
	return x;
}
